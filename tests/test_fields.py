...
def test_field_initiate(test_config):
    ...
    field.init(test_config, section, option)

    assert field._initiated is True
    assert field.value is test_config.get(section, option)
...
def test_default(test_config):
    ...
    assert field.value is default_value
...
def test_bool_field(test_config):
    ...
    assert field.value is test_config.getboolean(section, option)
...
def test_int_field(test_config):
    ...
    assert field.value is test_config.getint(section, option)
...
def test_float_field(test_config):
    ...
    assert field.value == test_config.getfloat(section, option)
